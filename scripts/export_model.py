...
VERSION = 1  # la versión que quieras usar (la 3 que se ve en tu UI)

def export_model(version=VERSION):
...
if __name__ == "__main__":
    ...
    version = int(sys.argv[1]) if len(sys.argv) > 1 else VERSION
    export_model(version)